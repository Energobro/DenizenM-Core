...
public class ColorTag implements ObjectTag {
    ...
    //
    // A list of accepted color names can be found at <@link tag util.color_names>.
    //
    ...
    public static void registerMinecraftCode(String name, int rgb) {
        colorsByName.put(name, fromRGB(rgb));
    }
    ...
    static {
        registerNamedColor("WHITE", 16777215, 255);
        registerNamedColor("SILVER", 12632256, 255);
        registerNamedColor("GRAY", 8421504, 255);
        registerNamedColor("BLACK", 0, 255);
        registerNamedColor("RED", 16711680, 255);
        registerNamedColor("MAROON", 8388608, 255);
        registerNamedColor("YELLOW", 16776960, 255);
        registerNamedColor("OLIVE", 8421376, 255);
        registerNamedColor("LIME", 65280, 255);
        registerNamedColor("GREEN", 32768, 255);
        registerNamedColor("AQUA", 65535, 255);
        registerNamedColor("TEAL", 32896, 255);
        registerNamedColor("BLUE", 255, 255);
        registerNamedColor("NAVY", 128, 255);
        registerNamedColor("FUCHSIA", 16711935, 255);
        registerNamedColor("PURPLE", 8388736, 255);
        registerNamedColor("ORANGE", 16753920, 255);
        registerNamedColor("TRANSPARENT", 0, 0);
        // Minecraft color codes are accepted by ColorTag
        registerMinecraftCode("§0", 0);
        registerMinecraftCode("§1", 170);
        registerMinecraftCode("§2", 43520);
        registerMinecraftCode("§3", 43690);
        registerMinecraftCode("§4", 11141120);
        registerMinecraftCode("§5", 11141290);
        registerMinecraftCode("§6", 16755200);
        registerMinecraftCode("§7", 11184810);
        registerMinecraftCode("§8", 5592405);
        registerMinecraftCode("§9", 5592575);
        registerMinecraftCode("§a", 5635925);
        registerMinecraftCode("§b", 5636095);
        registerMinecraftCode("§c", 16733525);
        registerMinecraftCode("§d", 16733695);
        registerMinecraftCode("§e", 16777045);
        registerMinecraftCode("§f", 16777215);
    }
    ...
    public static ColorTag valueOf(String string, TagContext context) {
        ...
        if (string.startsWith("#") && string.length() == 7 && HEX_MATCHER.isOnlyMatches(string.substring(1))) {
            return new ColorTag(fromRGB(Integer.parseInt(string.substring(1), 16)));
        }
            ...
            return new ColorTag(fromRGB(Integer.parseInt(string.substring(2), 16)));
        }
        else if (string.startsWith(COLOR_CHAR + "x") && string.length() == 14) {
            String pieces = string.substring(2).replace(String.valueOf(COLOR_CHAR), "");
            if (pieces.length() == 6 && HEX_MATCHER.isOnlyMatches(pieces)) {
                return new ColorTag(fromRGB(Integer.parseInt(pieces, 16)));
            }
        }
    ...
    public static ColorTag fromHSB(int[] hsv) {
        ...
        return new ColorTag(fromRGB(rgb));
    }
